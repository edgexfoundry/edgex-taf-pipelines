...
def integrationTest() {
    catchError {
        timeout(time: 50, unit: 'MINUTES') {
            ...
            def scriptName = branchName == 'odessa' ? 'runIntegrationTestScripts_v0.groovy' : 'runIntegrationTestScripts.groovy'
            def runIntegrationTestScripts = load "${rootDir}/${scriptName}"
