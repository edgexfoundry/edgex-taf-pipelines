...
def call(config) {
    ...
    pipeline {
        ...
        parameters {
            ...
            string(name: 'TAF_BRANCH', defaultValue: 'heads/issue-536-change-keyword', description: 'Test branch for edgexfoundry/edgex-taf repository. Examples: tags/tag or heads/branch')
